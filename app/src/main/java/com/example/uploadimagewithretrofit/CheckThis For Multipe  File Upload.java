        ...
        ///  CHECK THIS FOR FILE TO UPLOAD THIS CLASS IS FROM GITHUB




        // TO UPLOAD SINGLE FILE WITH NAME
//        @Multipart
//        @POST("retrofit_example/upload_image.php")
//    Call<ServerResponse> uploadFile(@Part MultipartBody.Part file,
//        @Part("file") RequestBody name);  // IN MUTLITPART ANY STRING WILL BE PASSED WITH @part AND Responsebody name
//


        // THIS IS TO UPLOAD MULTIPLE FILE
//        @Multipart
